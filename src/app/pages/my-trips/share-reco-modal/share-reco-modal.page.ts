...
@Component({
  selector: 'app-share-reco-modal',
  templateUrl: './share-reco-modal.page.html',
  styleUrls: ['./share-reco-modal.page.scss'],
})
export class ShareRecoModelPage implements OnInit {
  location: string;
  userName: string;
  smsContent: string;
  currentUser: any;
