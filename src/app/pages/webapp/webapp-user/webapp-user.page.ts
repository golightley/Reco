...
@Component({
  selector: 'app-webapp-user',
  templateUrl: './webapp-user.page.html',
  styleUrls: ['./webapp-user.page.scss'],
})
export class WebappUserPage implements OnInit {
  ...
  gotoSignup() {
    this.router.navigateByUrl('/signup/webapp');
  }
